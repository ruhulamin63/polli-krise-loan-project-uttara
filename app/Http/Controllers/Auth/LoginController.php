...
class LoginController extends Controller
{
    ...
    public function postRegistration(Request $request){
        ...
        if ($request->hasFile('image')) {
            ...
            Image::make($image)->resize(400, 400)->save('images/nid-image/'. $thumbnail);
        }else {
            $thumbnail = null;
        }
        ...
        if ($request->hasFile('nid_front_side_image')) {
            ...
            $thumbnail = time() . '.' . $image->getClientOriginalExtension();
            Image::make($image)->resize(400, 400)->save('images/ind-front-part/'. $thumbnail);
        }else {
            $thumbnail = null;
        }
        ...
        if ($request->hasFile('nid_back_side_image')) {
            ...
            $thumbnail = time() . '.' . $image->getClientOriginalExtension();
            Image::make($image)->resize(400, 400)->save('images/ind-back-part/'. $thumbnail);
        }else {
            $thumbnail = null;
        }
